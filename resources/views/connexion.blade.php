...
/* HERO */
.hero{
  position:relative;min-height:520px;padding:48px 40px;
...
p.lead{color:rgba(255,255,255,0.95);line-height:1.6;font-size:16px}
/* CARD */
.card{
...
input{
  padding:12px 14px;border-radius:12px;border:1px solid #e6e9ef;
...
.cta{
  margin-top:8px;padding:14px;border-radius:14px;border:0;
...
.meta a{color:var(--accent);cursor:pointer;text-decoration:none;font-weight:600}
.meta a:hover{text-decoration:underline;color:var(--accent-2)}

/* Social login */
.social-login{display:flex;gap:12px;margin:12px 0;flex-wrap:wrap;}
.social-btn{
  flex:1;padding:12px;border-radius:12px;
  border:1px solid #e6e9ef;cursor:pointer;
  display:flex;align-items:center;gap:10px;justify-content:center;
  transition:all .3s ease;font-weight:600;font-size:15px;background:#fff;
}
...
.toast{
  ...
  background:#0f172a;color:#fff;padding:14px 18px;border-radius:12px;
